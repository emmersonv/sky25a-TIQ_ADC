...
N 100 -130 100 -100 {lab=VDPWR}
N 100 -70 100 -30 {lab=Vout}
N 100 -170 100 -130 {lab=VDPWR}
N -90 -170 100 -170 {lab=VDPWR}
N 40 -100 60 -100 {lab=Vin}
...
C {lab_wire.sym} 40 -100 0 0 {name=p3 sig_type=std_logic lab=Vin}
