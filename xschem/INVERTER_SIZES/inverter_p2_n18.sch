...
N 80 70 80 170 {lab=VGND}
N 80 40 80 70 {lab=VGND}
N 80 -30 80 10 {lab=Vout}
N 20 40 40 40 {lab=Vin}
...
C {sky130_fd_pr/nfet_01v8.sym} 60 40 0 0 {name=M3
W=9
L=0.15
nf=2
mult=1
...
C {lab_wire.sym} 80 170 0 0 {name=p3 sig_type=std_logic lab=VGND}
C {lab_wire.sym} 20 40 0 0 {name=p4 sig_type=std_logic lab=Vin}
