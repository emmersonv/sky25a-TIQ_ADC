...
N -80 -120 -40 -120 {lab=VinW}
N -80 -120 -80 20 {lab=VinW}
N -80 20 -40 20 {lab=VinW}
N -120 -50 -80 -50 {lab=VinW}
N -190 -50 -120 -50 {lab=VinW}
...
C {code_shown.sym} 140 -330 0 0 {name=s1 only_toplevel=false value=
"
.lib /foss/pdks/sky130A/libs.tech/combined/sky130.lib.spice tt

.control
	dc Vin 0 1.8 0.01
	write inverter_sweep_test_inside.raw
.endc
"
}
